    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-gray-500 block sm:text-sm">
          ...
          <div className="relative flex w-full p-3 flex-auto flex-col place-content-inherit align-items-inherit h-auto break-words text-left overflow-y-auto subpixel-antialiased">
            <div className="space-y-3 text-sm text-gray-600">
              <div className="flex items-start gap-2">
                ...
                <span>
                  A tag da organização deve ser única e não pode ser alterada
                  após outros membros se juntarem
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-blue-500">•</span>
                <span>
                  O logo deve ser uma URL válida de uma imagem (PNG, JPG, GIF)
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-blue-500">•</span>
                <span>
                  Organizações públicas são visíveis para todos, enquanto
                  privadas só aparecem para membros
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-blue-500">•</span>
                <span>
                  Apenas o Owner da organização pode editar essas configurações
                </span>
              </div>
            </div>
          </div>
