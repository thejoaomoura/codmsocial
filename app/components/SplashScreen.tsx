      ...
      <div className="flex flex-col items-center space-y-6">
        ...
        <div className="relative">
          <div className="w-16 h-16 rounded-full border-4 border-transparent 
                          ...
                          animate-spin bg-[length:200%_200%] gradient-x">
        ...
        <div className="text-center">
          <h2 className="text-xl font-semibold bg-gradient-to-r from-red-500 via-green-500 to-blue-500 
                         bg-clip-text text-transparent gradient-x bg-[length:200%_200%]">
            Carregando...
          </h2>
        </div>
      </div>

      {/* Keyframes via style global */}
      <style>
        {`
