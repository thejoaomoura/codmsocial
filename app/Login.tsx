...
const Login: React.FC<LoginProps> = ({ handleGoogleLogin }) => {
  ...
  const actionCodeSettings = {
    url: mounted ? window.location.origin + '/login' : 'http://localhost:3000/login',
  ...
  useEffect(() => {
    ...
    if (mode === 'signIn' && oobCode && isSignInWithEmailLink(auth, window.location.href)) {
      ...
      if (!email) {
        email = window.prompt('Por favor, forneça seu email para confirmação e conclusão do login:');
      }
      ...
      if (email) {
        signInWithEmailLink(auth, email, window.location.href)
          ...
          .catch((error) => {
            ...
            addToast({
              ...
              description: error.message || "Erro ao confirmar login via email. Tente novamente.",
              color: "danger"
            });
          })
          .finally(() => {
        ...
        addToast({
          ...
          description: "É necessário fornecer o email para completar a autenticação.",
          color: "warning"
        });
      }
    }
      ...
      <Card className="w-full max-w-md bg-gray-900/80 backdrop-blur-xl border border-gray-700/50 shadow-2xl relative z-10">
        <CardHeader className="flex flex-col items-center gap-4 pb-6">
          ...
          <div className="text-center">
            <h4 className="font-bold text-2xl text-white mb-2">Gaming Social Network</h4>
        ...
        <CardBody className="flex flex-col gap-6 pt-0">
          ...
          <Tabs 
            ...
            classNames={{
              tabList: "bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 flex justify-center",
              ...
              <div className="flex flex-col gap-4">
                <Input
                  ...
                  classNames={{
                    ...
                    inputWrapper: "bg-gray-800/50 border border-gray-700/50 hover:border-gray-600 focus-within:border-purple-500 transition-colors",
                    label: "text-gray-300"
                  }}
                />
                <Input
            ...
            <Tab key="register" title="Cadastrar">
              <div className="flex flex-col gap-4">
                <Input
                  ...
                  classNames={{
                    input: "bg-transparent text-white placeholder:text-gray-500",
                    inputWrapper: "bg-gray-800/50 border border-gray-700/50 hover:border-gray-600 focus-within:border-green-500 transition-colors",
                    label: "text-gray-300"
                  }}
                />
                <Input
            ...
            <Tab key="emaillink" title="Link por Email">
              <div className="flex flex-col gap-4">
                <Input
                  ...
                  classNames={{
                    input: "bg-transparent text-white placeholder:text-gray-500",
                    inputWrapper: "bg-gray-800/50 border border-gray-700/50 hover:border-gray-600 focus-within:border-indigo-500 transition-colors",
                    label: "text-gray-300"
                  }}
                />
                <Button
